...
- **Swing** — first-person swing animation speed, visual only (`1.0` = normal, higher = snappier, e.g. `0.25` = slow-mo). Each swing plays its full arc before the next begins, spam-clicking won't cut it short, and your real swing/attack rate is never changed.
